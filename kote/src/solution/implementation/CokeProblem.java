...
// 받은 1병과 5병을 받았을 때
// 남은 1병을 모두 마신 뒤 가져가면 1병을 또 받을 수 있습니다.
...
// 상빈이가 받을 수 있는 콜라의 병 수를 return 해주세요.

// [제한사항]
// 1 ≤ b < a ≤ n ≤ 1,000,000
// 정답은 항상 int 범위를 넘지 않게 주어집니다.

// 1. 총 돌려받은 콜라의 개수를 세는 count를 선언합니다.
// 2. n을 a로 나눈 몫을 선언하고, 마트가 주는 콜라의 개수와 곱합니다.
// 3. n에 n을 a로 나눈 나머지와 "2"에서 구한 값을 더하여 저장합니다.
// 4. count에 "2"에서 구한 값을 더합니다.
// 5. n이 a이상일 때 동안 2~4를 반복합니다.
// 6. count를 반환합니다.
